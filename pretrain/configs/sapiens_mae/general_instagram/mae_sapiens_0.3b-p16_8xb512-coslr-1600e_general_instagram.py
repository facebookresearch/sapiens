...
# https://www.internalfb.com/intern/wiki/RL/RL_Research/Pittsburgh/The_Legion_Dataset/Instagram_data/
general_instagram_dataset = dict(
        type='GeneralInstagram',
        data_root='data/general_instagram',
        airstore_id='codec_avatars_ig_image_non_human_centric_source20240226_v0',
        concepts_def_path='/checkpoint/avatar/suzhaoen/ITW_metadata/ig/xray_detection_concept_list_prod.csv',
        split='train',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[general_instagram_dataset]
    ),
    )
