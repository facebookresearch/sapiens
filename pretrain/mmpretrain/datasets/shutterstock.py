...
class Shutterstock(AirstoreBaseDataset):
    ...
    def load_data_list(self):
        ...
        print('\033[92m' + 'Rank:{}, World Size:{}, Batch Size:{}, Loading {} shutterstock dummy samples from airstore'.format(\
            self.global_rank, self.world_size, self.batch_size, total_samples) + '\033[0m') ## 48055045 - 48M
