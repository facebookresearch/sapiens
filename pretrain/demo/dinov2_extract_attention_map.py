...
def main():
    ...
    # processor.save_pretrained('/home/rawalk/Downloads/dinov2-giant/processor')
    # model.save_pretrained('/home/rawalk/Downloads/dinov2-giant/model')

    ##--------------------from local------------------------
    processor = AutoImageProcessor.from_pretrained('/mnt/home/rawalk/Desktop/sapiens/pretrain/checkpoints/dinov2-giant/processor')
    model = AutoModel.from_pretrained('/mnt/home/rawalk/Desktop/sapiens/pretrain/checkpoints/dinov2-giant/model')
