...
###--------------------------------------------------------------
CONFIG_FILE=configs/mae_sapiens/${MODEL}.py
...
LOAD_FROM=''
# LOAD_FROM='checkpoints/mae_in1k_epoch_1600.pth'
...
if [ "$mode" = "debug" ]; then
    DEBUG_TRAIN_BATCH_SIZE_PER_GPU=4 ## works for single gpu
