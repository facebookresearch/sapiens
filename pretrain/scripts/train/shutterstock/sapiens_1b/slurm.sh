...
<<<<<<<< HEAD:pretrain/scripts/train/shutterstock/sapiens_0.6b/slurm.sh
MODEL="sapiens_0.6b_${DATASET}"
TRAIN_BATCH_SIZE_PER_GPU=16
========
MODEL="sapiens_1b_${DATASET}"
TRAIN_BATCH_SIZE_PER_GPU=10
>>>>>>>> main:pretrain/scripts/train/shutterstock/sapiens_1b/slurm.sh
JOB_NAME=$MODEL
...
<<<<<<<< HEAD:pretrain/scripts/train/shutterstock/sapiens_0.6b/slurm.sh
========
RESUME_FROM='/home/rawalk/drive/pretrain/Outputs/train/shutterstock/sapiens_1b_shutterstock/slurm/07-08-2024_05:27:27/iter_192000.pth'
