...
# IMAGE_DIR='attention2'
# IMAGE_DIR='attention3'
IMAGE_DIR='attention4'

INPUT=./demo/data/$IMAGE_DIR
OUTPUT=/mnt/home/rawalk/Desktop/sapiens/pretrain/Outputs/vis/$IMAGE_DIR
...
CHECKPOINT='/mnt/home/rawalk/sapiens_host/pretrain/checkpoints/sapiens_1b/sapiens_1b_shutterstock_instagram_epoch_173.pth'

##-------------------------------------inference-------------------------------------
RUN_FILE='demo/extract_attention_map.py'
