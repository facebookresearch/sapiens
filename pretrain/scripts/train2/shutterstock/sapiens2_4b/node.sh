...
# LOAD_FROM='/home/rawalk/drive/pretrain/Outputs/train2/shutterstock/sapiens2_4b_shutterstock/slurm/08-05-2024_20:18:33/iter_10000.pth'
...
if [ "$mode" = "debug" ]; then
    DEBUG_TRAIN_BATCH_SIZE_PER_GPU=1 ## works for single gpu
