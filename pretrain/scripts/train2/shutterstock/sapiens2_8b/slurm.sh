...
# RESUME_FROM='/gen_ca/rawalk/debug/sapiens2_8b/iter_40000.pth' ## default. resume is OOM
RESUME_FROM='' ## default. resume is OOM
LOAD_FROM=''
...
CONDA_ENV="/uca/conda-envs/dgxenv-2024-08-19-08-10-34-x3266-centos9-py310-pt231/bin/activate"
TIME='7-00:00:00'
JOB_NAME="${JOB_NAME}"
