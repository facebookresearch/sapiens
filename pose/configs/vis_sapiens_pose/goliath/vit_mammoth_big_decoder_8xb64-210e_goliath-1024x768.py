...
pretrained_checkpoint='../pretrain/checkpoints/shutterstock/vit_mammoth_1024x1024/vit_mammoth_1024x1024_epoch_173_shutterstock_no_backbone_prefix.pth'
...
# hooks
default_hooks = dict(
    checkpoint=dict(save_best='goliath/AP', rule='greater', by_epoch=False, interval=100, max_keep_ckpts=-1),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[dataset_goliath, dataset_coco_wholebody],
