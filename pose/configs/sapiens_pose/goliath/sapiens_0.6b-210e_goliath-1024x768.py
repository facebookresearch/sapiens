...
pretrained_checkpoint='../pretrain/checkpoints/shutterstock_instagram/sapiens_0.6b/sapiens_0.6b_shutterstock_instagram_epoch_1600_clean.pth'
...
dataset_coco_wholebody_train = dict(
    type='CocoWholeBody2GoliathDataset',
    data_root='data/coco',
    data_mode='topdown',
...
###---------------------------------------------------------------
external_datasets_frequency = 2 ## increase the frequency to get more samples from these datasets
