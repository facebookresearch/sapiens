...
pretrained_checkpoint='../pretrain/checkpoints/shutterstock_instagram/sapiens_1b/sapiens_1b_shutterstock_instagram_epoch_173_clean.pth' ## old checkpoint
# pretrained_checkpoint='../pretrain/checkpoints/shutterstock_instagram/sapiens_1b/sapiens_1b_shutterstock_instagram_epoch_360_clean.pth' ## both data
# pretrained_checkpoint='../pretrain/checkpoints/shutterstock_instagram/sapiens_1b/sapiens_1b_shutterstock_instagram_epoch_555_clean.pth' ## latest both data
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[dataset_coco, dataset_mpii_train, dataset_mpii_val, dataset_crowdpose_trainval, dataset_aic_train, dataset_aic_val],
