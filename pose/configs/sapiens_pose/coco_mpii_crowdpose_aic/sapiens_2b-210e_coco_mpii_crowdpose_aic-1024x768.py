...
pretrained_checkpoint='../pretrain/checkpoints/shutterstock_instagram/sapiens_2b/sapiens_2b_shutterstock_instagram_epoch_660_clean.pth'
...
# ## polynomial learning policy from segmentation
# param_scheduler = [
#     dict(
#         type='LinearLR', begin=0, end=500, start_factor=0.001,
#         by_epoch=False),  # warm-up
