...
class AirstoreDataLoader(torch.utils.data.Dataset):
    def __init__(self, ann_file, mode, num_pts, num_seg):
        ...
        self.data_list = sorted(data_list, key=lambda y: (y['session_id'], y['camera_id'], y['frame_id']))
...
if __name__ == "__main__":
    ...
    images_output_dir = f'/home/rawalk/drive/pose/data/goliath/{mode}/images'
    keypoints_output_dir = f'/home/rawalk/drive/pose/data/goliath/{mode}/keypoints'
    ...
    step = 50 ##  every 60th sample, basically 2 seconds at 30 fps
    ...
    for i in range(len(dataset)):
        ...
        this_images_output_dir = os.path.join(images_output_dir, session_id, camera_id)
        this_keypoints_output_dir = os.path.join(keypoints_output_dir, session_id, camera_id)
