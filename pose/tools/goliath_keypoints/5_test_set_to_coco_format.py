    ...
    for camera_name in sorted(os.listdir(subject_dir)):
        ...
        for image_name in image_names:
            ...
            with open(gt_keypoints_path, 'rb') as f:
                ...
                ## remove the teeth keypoints
                if GOLIATH_INFO['remove_teeth'] == True:
                    gt_keypoints = gt_keypoints[teeth_mask, :] ## 308 x 3
                    assert len(gt_keypoints) == original_num_keypoints - len(teeth_ids)
...
##---------------------------------------------------------------------
gt_to_coco_json(gt_dicts, outfile_path=os.path.join(ROOT_DIR, 'annotations', 'person_keypoints_test2023_10k.json'))
