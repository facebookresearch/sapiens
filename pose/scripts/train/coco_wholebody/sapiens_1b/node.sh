...
###----------if you want to create a checkpoint with backbone prefix--------------------------------------
# CHECKPOINT_PATH=../mmpretrain/checkpoints/shutterstock/vit_mammoth_1024x1024/vit_mammoth_1024x1024_epoch_296_shutterstock.pth
