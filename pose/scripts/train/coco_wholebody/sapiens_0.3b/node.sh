...
# # # # ###----------if you want to create a checkpoint without backbone prefix--------------------------------------
# CHECKPOINT_PATH=/uca/rawalk/sapiens2_host/pretrain/checkpoints/sapiens2_0.6b/sapiens2_0.6b_shutterstock_iter_415000.pth
# CHECKPOINT_PATH=/uca/rawalk/sapiens2_host/pretrain/checkpoints/sapiens2_0.3b/checkpoints/sapiens2_0.3b_shutterstock_iter_470000.pth
# python tools/misc/create_no_backbone_prefix_checkpoint.py $CHECKPOINT_PATH; exit
