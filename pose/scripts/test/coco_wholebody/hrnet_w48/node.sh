...
MODEL="td-hm_hrnet-w48_dark-8xb32-210e_${DATASET}-384x288"
JOB_NAME='pose_whole_td-hm_hrnet-w48_dark_384x288'
TEST_BATCH_SIZE_PER_GPU=256

CHECKPOINT='/home/rawalk/drive/mmpose/Outputs/train/coco_wholebody/td-hm_hrnet-w48_dark-8xb32-210e_coco_wholebody-384x288/slurm/11-11-2023_02:25:09/best_coco-wholebody_AP_epoch_200.pth'
...
CONFIG_FILE=configs/wholebody_2d_keypoint/topdown_heatmap/${DATASET}/${MODEL}.py
