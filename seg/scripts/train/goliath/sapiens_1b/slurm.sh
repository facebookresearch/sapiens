...
RESUME_FROM=''
RESUME_FROM='/home/rawalk/drive/seg/Outputs/train/goliath/sapiens_1b_goliath-1024x768/slurm/06-26-2024_04:12:24/epoch_113.pth'
...
CONDA_ENV='/uca/conda-envs/dgxenv-2024-06-08-13-32-31-x2608-rsc/bin/activate'
TIME='7-00:00:00'
JOB_NAME="${JOB_NAME}"
