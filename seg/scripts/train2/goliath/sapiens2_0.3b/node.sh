...
####-----------------MODEL_CARD----------------------------
DATASET='goliath'
MODEL="sapiens2_0.3b_${DATASET}-4096x3072"

JOB_NAME="seg_$MODEL"
TRAIN_BATCH_SIZE_PER_GPU=2

RESUME_FROM='/home/rawalk/drive/seg/Outputs/train2/goliath/sapiens2_0.3b_goliath-4096x3072/slurm/07-25-2024_14:36:08/epoch_12.pth'
LOAD_FROM=''
...
###--------------------------------------------------------------
CONFIG_FILE=configs/sapiens2_seg/${DATASET}/${MODEL}.py
OUTPUT_DIR="Outputs/train2/${DATASET}/${MODEL}/node"
...
if [ "$mode" = "debug" ]; then
    ...
    # OPTIONS="$(echo "train_dataloader.batch_size=${TRAIN_BATCH_SIZE_PER_GPU}")"
