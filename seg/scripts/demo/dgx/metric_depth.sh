...
OUTPUT='/mnt/home/rawalk/Desktop/sapiens/seg/Outputs/vis/itw_videos/reel1_metric_depth'

#--------------------------MODEL CARD---------------
MODEL_NAME='sapiens_1b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/metric_depth/checkpoints/sapiens_1b/sapiens_1b_metric_render_people_epoch_50.pth
