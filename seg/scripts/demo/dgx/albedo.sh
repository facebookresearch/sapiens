...
OUTPUT='/mnt/home/rawalk/Desktop/sapiens/seg/Outputs/vis/albedo'

#--------------------------MODEL CARD---------------
MODEL_NAME='sapiens_1b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/albedo/checkpoints/sapiens_1b/sapiens_1b_albedo_render_people_epoch_42.pth
