...
INPUT='./demo/data/lightmap'
OUTPUT='/mnt/home/rawalk/Desktop/sapiens/seg/Outputs/vis/hdri'

#--------------------------MODEL CARD---------------
MODEL_NAME='sapiens_1b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/hdri/checkpoints/sapiens_1b/sapiens_1b_hdri_epoch_77.pth
