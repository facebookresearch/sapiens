...
####-----------------MODEL_CARD----------------------------
DATASET='lip'
MODEL="sapien_0.3b_${DATASET}-1024x768"
JOB_NAME="test_seg_$MODEL"
TEST_BATCH_SIZE_PER_GPU=32

CHECKPOINT='/uca/rawalk/sapiens/seg/checkpoints/sapien_0.3b/sapien_0.3b_lip_best_lip_mIoU_5484.pth'
