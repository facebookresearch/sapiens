...
# CHECKPOINT='/home/rawalk/drive/seg/Outputs/train2/normal_render_people/sapiens2_0.6b_normal_render_people-4096x3072/slurm/07-25-2024_04:30:41/iter_6000.pth'
# CHECKPOINT='/home/rawalk/drive/seg/Outputs/train2/normal_render_people/sapiens2_0.6b_normal_render_people-4096x3072/slurm/07-25-2024_04:30:41/iter_10000.pth'
# CHECKPOINT='/home/rawalk/drive/seg/Outputs/train2/normal_render_people/sapiens2_0.6b_normal_render_people-4096x3072/slurm/07-25-2024_04:30:41/iter_11000.pth'
CONFIG_FILE="configs/sapiens2_normal/${DATASET}/${MODEL}.py"

# ###--------------------------------------------------------------------------------
DATA_PREFIX="hi4d/evaluation/rgb"
SEG_DIR="${DATA_DIR}/hi4d/evaluation/mask"
