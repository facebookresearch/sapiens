...
model = dict(
    ...
    decode_head=dict(
        type='VitMetricDepthHead',
        in_channels=embed_dim,
        channels=384,
        deconv_out_channels=(384, 384, 384, 384), ## 16x
        ...
        align_corners=False,
        loss_decode=[\
        dict(type='MetricDepthL1Loss', reduction='mean', loss_weight=1.0, eps=-100),
        dict(type='MetricSiLogLoss', loss_weight=1.0, eps=-100, background_val=-1000),
        ],
    ),
...
train_pipeline = [
    ...
    dict(type='GenerateMetricDepthTarget', background_val=-1000),
...
dataset_goliath_train = dict(
        type='MetricRenderPeopleDataset',
