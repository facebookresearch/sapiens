...
default_hooks = dict(
    ...
    visualization=dict(type='GeneralVisualizationHook', interval=vis_every_iters, max_samples=4, vis_image_width=384, vis_image_height=512),
    )
