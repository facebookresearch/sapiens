...
##-----------------------------------------------------------------
# model_name = 'sapien_0.3b'; embed_dim=1024; num_layers=24
model_name = 'sapien_0.6b'; embed_dim=1280; num_layers=32
# model_name = 'sapien_1b'; embed_dim=1536; num_layers=40
# model_name = 'sapien_2b'; embed_dim=1920; num_layers=48
# model_name = 'sapien_4b'; embed_dim=2432; num_layers=56
# model_name = 'sapien_8b'; embed_dim=3264; num_layers=64
...
pretrained_checkpoint='../pretrain/checkpoints/shutterstock_instagram/sapien_0.6b/sapien_0.6b_shutterstock_instagram_epoch_1600_clean.pth'
