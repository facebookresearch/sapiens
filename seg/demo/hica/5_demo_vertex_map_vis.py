...
def main():
    ...
    for i, image_name in tqdm(enumerate(image_names), total=len(image_names)):
        ...
        pred_vertex_map = result.transpose(1, 2, 0) ### (H, W, C)
        raw_pred_vertex_map = np.copy(pred_vertex_map)
