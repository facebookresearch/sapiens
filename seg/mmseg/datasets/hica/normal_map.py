...
class HiCaNormalMapDataset(BaseSegDataset):
    def __init__(self,
                 **kwargs) -> None:
    ...
    def load_data_list(self) -> List[dict]:
        ...
        print('\033[92mDone! HiCaNormalMap. Loaded total samples: {}\033[0m'.format(len(data_list))) ## 98424 images train
    ...
    def get_data_info(self, idx):
        ...
        container_path = os.path.join(self.data_root, data_info['airstore_id'], "vn_img.zip")
        ...
        normal_map_container = typed.open_container(container_path, mode="r")

        frame_id = int(data_info['frame_id'])
        normal = normal_map_container.load(f"{data_info['segment']}/{frame_id:06d}.npy") # (h, w, 3) & float32
